...
import { BtnShadowLinearComponent, Container, ProgressShippingComponent, RowComponent, SectionComponent, SpaceComponent, TextComponent } from '../../components'
...
const data2 = [
  {
    ...
    description: 'Order will be delivered between 3 - 4 business days straights to your doorstep.',
    price: 3
  },
  {
...

          {
            data2.map((_, index) =>
              <SectionComponent
                key={index}
                styles={{
                  backgroundColor: method === _.title ? colors.primary : colors.background,
                  paddingVertical: 10,
                  marginVertical: 6
                }}>
                ...
                >
                  ...
                  <TextComponent
                    ...
                    size={sizes.bigText}
                    color={method === _.title ? colors.background : colors.primary}
                  />
                </RowComponent>
              </SectionComponent>
            )
