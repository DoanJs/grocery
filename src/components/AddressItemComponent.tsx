import { ArrowDown2, ArrowUp2, Barcode, Call, ForwardItem, GlobalSearch, Location, User } from 'iconsax-react-native'
            ...
            </SectionComponent>
            {
                ...
                <>
                    ...
                    <SectionComponent styles={{
                        ...
                        <RowComponent onPress={handleMakeDefault}>
                            <View
                                style={{
                                    height: 18,
                                    width: 32,
                                    borderRadius: 20,
                                    borderWidth: 1,
                                    borderColor: addressDefault ? colors.primary : colors.text,
                                    flexDirection: 'row',
                                    justifyContent: addressDefault ? 'flex-end' : 'flex-start',
                                    backgroundColor: addressDefault ? colors.primary : colors.text,
                                }}
                            >
                                <View
                                    style={{
